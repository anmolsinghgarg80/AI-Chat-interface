...
const Chat = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 ml-0 md:ml-72 flex flex-col h-full">
        <div className="flex-1 overflow-y-auto scrollbar-thin px-4 pt-4 pb-40">
          {loading ? (
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-background/80 backdrop-blur-sm py-4 px-4 md:pl-80">
